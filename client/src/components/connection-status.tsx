    ...
    return (
        <Tooltip>
            <TooltipTrigger asChild>
                <button className="flex items-center gap-2 px-3 py-1 rounded-md hover:bg-primary/10 transition-colors font-mono text-xs">
                    <motion.div 
                        className="relative"
                        animate={connected ? {
                            scale: [1, 1.05, 1],
                    ...
                    >
                        {isLoading ? (
                            <Wifi className="text-primary/60 size-4" />
                        ) : connected ? (
                            <SignalHigh className="text-primary size-4" />
                        ) : (
                            <Wifi className="text-red-500 size-4" />
                        )}
